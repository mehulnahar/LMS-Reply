  ...
  try {
    ...
    res.json({
      ...
      job: jobRows.length > 0 ? {
        ...
        upworkLink: jobRows[0].upwork_link || null,
        country: jobRows[0].country || null,
        city: jobRows[0].city || null,
        company: jobRows[0].company || null,
        workload: jobRows[0].workload || null,
        duration: jobRows[0].duration || null,
        paymentType: jobRows[0].payment_type || null,
        amount: jobRows[0].amount || null,
        hourlyBudgetMin: jobRows[0].hourly_budget_min || null,
        hourlyBudgetMax: jobRows[0].hourly_budget_max || null,
        hourlyBudgetType: jobRows[0].hourly_budget_type || null,
        isPaymentVerified: jobRows[0].is_payment_verified || null,
        isEnterprise: jobRows[0].is_enterprise || null,
        buyerHistoryAmount: jobRows[0].buyer_history_amount || null,
        avgHourlyRate: jobRows[0].avg_hourly_rate || null,
        totalJobsPosted: jobRows[0].total_jobs_posted || null,
        totalJobsWithHires: jobRows[0].total_jobs_with_hires || null,
        contractorTier: jobRows[0].contractor_tier || null,
        category: jobRows[0].category || null,
        subCategory: jobRows[0].sub_category || null,
